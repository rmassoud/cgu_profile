 ...
 * password is set).
 */
function cguweb_install_tasks($install_state) {
 ...
 */
function cguweb_install_tasks_alter(&$tasks, $install_state) {
 ...
 */
function cguweb_form_install_configure_form_alter(&$form, $form_state) {
  ...
  $form['site_information']['site_name']['#default_value'] = 'CGUWeb';
